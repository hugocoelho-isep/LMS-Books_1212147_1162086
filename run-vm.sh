...
if docker service ls --filter "name=lmsbooks" --format "{{.Name}}" | grep -q "^lmsbooks$"; then
  ...
  docker service create -d \
    ...
    --env file.upload-dir=/home/hugo_hec/docker/uploads-psoft-g1-instance \
    --env spring.rabbitmq.host=rabbitmq \
    --mount type=bind,source=/home/hugo_hec/docker,target=/tmp/uploads-psoft-g1-instance \
    --publish 8087:8080 \
    --network lms_overlay_attachable_network \
    hugocoelhoisep/lmsbooks:latest
